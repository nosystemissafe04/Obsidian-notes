...
3. Fill in the blank: Cybersecurity almost always requires reasoning under ________?
...
2. Fill in the blank. Social Engineering generally exploits vulnerabilities in __________?
...
The attack impacted the confidentiality of the personal information of millions of current, former, and prospective customers. The confidentiality of this information was subsequently further compromised by being made available for purchase on the dark web. This also led to further reputational damage to T-Mobile as the attack was one of several then-recent breaches. The impact on confidentiality could have been avoided if the information had been properly encrypted, preventing the attackers from reading the information in cleartext.
...
1. Which algorithm can be used to split access for administration between multiple administrators?
...
3. Fill in the blank: _____ _____ is a methodology that encourages unpredictable environments that impact security, to provide teams and processes robust experience handling critical events.
...
6. Taking data from real-world adversaries and evaluating those attack patterns and techniques against our people, processes, systems, and software is called what?
...
![Figure 1: NIST Cyber Security Framework](https://static.offsec.com/offsec-courses/LIBRARY/imgs/intro_to_cybersecurity/c8ca6a62c3813312b5abff70f2ce0b4d-csf.png)
...
![Figure 2: Anatomy of Cyber](https://static.offsec.com/offsec-courses/LIBRARY/imgs/intro_to_cybersecurity/747b51cf6517063d3a5c7ee6788cac22-carsten1.png)
...
![Figure 3: Roles Mapped to Anatomy](https://static.offsec.com/offsec-courses/LIBRARY/imgs/intro_to_cybersecurity/8c189d337cd43b6132674fb4ede51f85-carsten2.png)
...
1. Which job role is primarily concerned with proactively searching for intruders and indicators of compromise on a network or set of systems?
