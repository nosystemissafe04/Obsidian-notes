...
2. Launch VM Group 2 and once connected as _jeff_ on client74 and try to move laterally to web04 in order to get the flag located on the administrator's desktop.
