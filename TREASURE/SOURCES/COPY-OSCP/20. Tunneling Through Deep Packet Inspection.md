...
2. Start VM Group 2. Download the **chisel_exercise_client** binary from the _Resources_ section to your Kali machine. If you're running the _aarch64_ build of Kali, download the **chisel_exercise_client_aarch64** binary instead. There's a server running on port 8008 on PGDATABASE01. Set up a port forward using Chisel that allows you to run the binary you downloaded against port 8008 on PGDATABASE01.
