...
```shell-session
0xxNosystemisSafe@htb[/htb]$ ls /usr/share/nishang/Antak-WebShell
...
```shell-session
0xxNosystemisSafe@htb[/htb]$ cp /usr/share/nishang/Antak-WebShell/antak.aspx /home/administrator/Upload.aspx
```
