...
```shell-session
0xxNosystemisSafe@htb[/htb]$ git clone https://github.com/thewhiteh4t/FinalRecon.git
0xxNosystemisSafe@htb[/htb]$ cd FinalRecon
0xxNosystemisSafe@htb[/htb]$ pip3 install -r requirements.txt
0xxNosystemisSafe@htb[/htb]$ chmod +x ./finalrecon.py
0xxNosystemisSafe@htb[/htb]$ ./finalrecon.py --help
...
```shell-session
0xxNosystemisSafe@htb[/htb]$ ./finalrecon.py --headers --whois --url http://inlanefreight.com
