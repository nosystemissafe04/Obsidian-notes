...
> [!Technology stack = web fingerprinting ]
...
```shell-session
0xxNosystemisSafe@htb[/htb]$ curl -I inlanefreight.com
```
...
```shell-session
0xxNosystemisSafe@htb[/htb]$ curl -I https://inlanefreight.com
...
```shell-session
0xxNosystemisSafe@htb[/htb]$ curl -I https://www.inlanefreight.com
...
```shell-session
0xxNosystemisSafe@htb[/htb]$ pip3 install git+https://github.com/EnableSecurity/wafw00f
```
...
```shell-session
0xxNosystemisSafe@htb[/htb]$ wafw00f inlanefreight.com
...
```shell-session
0xxNosystemisSafe@htb[/htb]$ sudo apt update && sudo apt install -y perl
0xxNosystemisSafe@htb[/htb]$ git clone https://github.com/sullo/nikto
0xxNosystemisSafe@htb[/htb]$ cd nikto/program
0xxNosystemisSafe@htb[/htb]$ chmod +x ./nikto.pl
```
...
```shell-session
0xxNosystemisSafe@htb[/htb]$ nikto -h inlanefreight.com -Tuning b
```
