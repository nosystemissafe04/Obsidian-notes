...
```shell-session
0xxNosystemisSafe@htb[/htb]$ pip3 install scrapy
```
...
```shell-session
0xxNosystemisSafe@htb[/htb]$ wget -O ReconSpider.zip https://academy.hackthebox.com/storage/modules/144/ReconSpider.v1.2.zip
0xxNosystemisSafe@htb[/htb]$ unzip ReconSpider.zip 
```
...
```shell-session
0xxNosystemisSafe@htb[/htb]$ python3 ReconSpider.py http://inlanefreight.com
```
