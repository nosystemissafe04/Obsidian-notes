...
```shell-session
0xxNosystemisSafe@htb[/htb]# nmap -p53 -Pn -sV -sC 10.10.110.213
...
```shell-session
0xxNosystemisSafe@htb[/htb]# dig AXFR @ns1.inlanefreight.htb inlanefreight.htb
...
```shell-session
0xxNosystemisSafe@htb[/htb]# fierce --domain zonetransfer.me
...
```shell-session
0xxNosystemisSafe@htb[/htb]# ./subfinder -d inlanefreight.com -v       
...
```shell-session
0xxNosystemisSafe@htb[/htb]$ git clone https://github.com/TheRook/subbrute.git >> /dev/null 2>&1
0xxNosystemisSafe@htb[/htb]$ cd subbrute
0xxNosystemisSafe@htb[/htb]$ echo "ns1.inlanefreight.com" > ./resolvers.txt
0xxNosystemisSafe@htb[/htb]$ ./subbrute inlanefreight.com -s ./names.txt -r ./resolvers.txt
...
```shell-session
0xxNosystemisSafe@htb[/htb]# host support.inlanefreight.com
...
```shell-session
0xxNosystemisSafe@htb[/htb]# cat /etc/ettercap/etter.dns
