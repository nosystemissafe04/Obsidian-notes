...
```bash
0xxNosystemisSafe@htb[/htb]$ cat /etc/ssh/sshd_config  | grep -v "#" | sed -r '/^\s*$/d'
...
```bash
0xxNosystemisSafe@htb[/htb]$ git clone https://github.com/jtesta/ssh-audit.git && cd ssh-audit
0xxNosystemisSafe@htb[/htb]$ ./ssh-audit.py 10.129.14.132
...
```shell-session
0xxNosystemisSafe@htb[/htb]$ ssh -v cry0l1t3@10.129.14.132
...
```shell-session
0xxNosystemisSafe@htb[/htb]$ ssh -v cry0l1t3@10.129.14.132 -o PreferredAuthentications=password
...
```bash
0xxNosystemisSafe@htb[/htb]$ sudo nmap -sV -p 873 127.0.0.1
...
```bash
0xxNosystemisSafe@htb[/htb]$ nc -nv 127.0.0.1 873
...
```bash
0xxNosystemisSafe@htb[/htb]$ rsync -av --list-only rsync://127.0.0.1/dev
...
```bash
0xxNosystemisSafe@htb[/htb]$ cat /etc/hosts.equiv
...
```bash
0xxNosystemisSafe@htb[/htb]$ sudo nmap -sV -p 512,513,514 10.0.17.2
...
```bash
0xxNosystemisSafe@htb[/htb]$ cat .rhosts
...
```bash
0xxNosystemisSafe@htb[/htb]$ rlogin 10.0.17.2 -l htb-student
...
```bash
0xxNosystemisSafe@htb[/htb]$ rwho
...
```bash
0xxNosystemisSafe@htb[/htb]$ rusers -al 10.0.17.5
