...
```bash
0xxNosystemisSafe@htb[/htb]$ locate mssqlclient
...
```bash
0xxNosystemisSafe@htb[/htb]$ sudo nmap --script ms-sql-info,ms-sql-empty-password,ms-sql-xp-cmdshell,ms-sql-config,ms-sql-ntlm-info,ms-sql-tables,ms-sql-hasdbaccess,ms-sql-dac,ms-sql-dump-hashes --script-args mssql.instance-port=1433,mssql.username=sa,mssql.password=,mssql.instance-name=MSSQLSERVER -sV -p 1433 10.129.201.248
...
```bash
0xxNosystemisSafe@htb[/htb]$ python3 mssqlclient.py Administrator@10.129.201.248 -windows-auth
