...
```shell-session
0xxNosystemisSafe@htb[/htb]$ locate *2john*
...
```shell-session
0xxNosystemisSafe@htb[/htb]$ ssh2john.py SSH.private > ssh.hash
0xxNosystemisSafe@htb[/htb]$ cat ssh.hash 
...
```shell-session
0xxNosystemisSafe@htb[/htb]$ john --wordlist=rockyou.txt ssh.hash
...
```shell-session
0xxNosystemisSafe@htb[/htb]$ john ssh.hash --show
...
```shell-session
0xxNosystemisSafe@htb[/htb]$ office2john.py Protected.docx > protected-docx.hash
0xxNosystemisSafe@htb[/htb]$ cat protected-docx.hash
...
```shell-session
0xxNosystemisSafe@htb[/htb]$ john --wordlist=rockyou.txt protected-docx.hash
...
```shell-session
0xxNosystemisSafe@htb[/htb]$ john protected-docx.hash --show
...
```shell-session
0xxNosystemisSafe@htb[/htb]$ pdf2john.py PDF.pdf > pdf.hash
0xxNosystemisSafe@htb[/htb]$ cat pdf.hash 
...
```shell-session
0xxNosystemisSafe@htb[/htb]$ john --wordlist=rockyou.txt pdf.hash
...
```shell-session
0xxNosystemisSafe@htb[/htb]$ john pdf.hash --show
