...
```shell-session
0xxNosystemisSafe@htb[/htb]$ pypykatz lsa minidump /home/peter/Documents/lsass.dmp 
...
2. pply the concepts taught in this section to obtain the password to the Vendor user account on the target. Submit the clear-text password as the answer. (Format: Case sensitive)
