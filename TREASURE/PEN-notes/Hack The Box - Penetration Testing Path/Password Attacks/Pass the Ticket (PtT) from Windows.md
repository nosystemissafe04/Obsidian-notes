...
**the same thing  cannot be done with rubeus it will give you aes256 key but there it need to be ( Hash must be 16, 32 or 64 characters in length )**
![[Pasted image 20250115124154.png]]

1. 16 byte for ntlm 32 characters  in hexadecimal  
2. aes128 16 byte 32 characters in hexadecimal 
3. 32 byte for aes256 64 character in hexadecimal 

![[Pasted image 20250115120842.png]]


**it is encoded in base64 and not in hexadecimal i tried to decode it with python and encode it in hex and tried the same thing buT no luck ......**
![[Pasted image 20250115124315.png]]
![[Pasted image 20250115124336.png]]

**after that i am getting this error** 
**it is concluded that from my point it cannot be done via rubeus** 
**we have to use mimikatz to get the key to generate the ticket or we need the actual password of the user to get the ticket** 
...
***here we dont get the tgt . it is imported in the session to get the current session tgt and tgs of the services . or get information of tgt exported*** [[Information about session TGT & TGS]]
