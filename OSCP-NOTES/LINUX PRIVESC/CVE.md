...
- TO READ ABOUT WHAT WAS PATCHED , GO TO ISSUES AND CHANGE `OPEN` TO `CLOSED` ISSUE TO FIND THE THE FIXES HERE WE WILL FIND BLOG POSTS OF SECURITY RESEARCHERS AND PROF
