...
WHAT WE DID HERE IS WE REWRITTEN .htaccess CONFIG WHICH IS USUALLY NOT WRITABLE , WE CHANGED THE FILENAME TO HTACCESS AND WROTE `REWRITEENGINE OFF` 
WHICH WILL <mark class="hltr-green-flag">IGNORE ALL THE RULES IN THE CONFIG FILE</mark> , OTHERWISE IN APACHE MOST OFTEN ITS NOT ALLOWED TO EXECUTE AN UPLOADED FILE , 
