...
*CHECK THE /etc/passwd FILE PERMISSION IF WE CAN WRITE TO THIS FILE WE CAN APPEND OUR OWN CREATED PASSWORD , THE PASSWORD IS STORED IN /etc/shadow FILE NORMALLY BUT IF THERE IS A PASSWORD PRESENT IN /*