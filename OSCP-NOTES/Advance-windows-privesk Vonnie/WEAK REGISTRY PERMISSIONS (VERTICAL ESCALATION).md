...
- Displays a service's (SECURITY)(https://learn.microsoft.com/en-us/windows/win32/secauthz/security-descriptors], using the Security Descriptor Definition Language (SDDL).
