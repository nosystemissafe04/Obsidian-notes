...
NOW WITH THIS SCRIPT WE KNOW WHICH SERVICE ARE RUN BY LOCALSYSTEM AND MANUALLY STARTED AND WHICH OF THEM CAN BE STARTABLE BY US , THE ACCESSCHK WAS JUST VERIFICATION WE ARE FINDDING THOSE SERVICES WITH SC SDSHOW COMMAND TO FIND WRITABLE SERVICE IMAGEPATH BY US WHICH IS AUTHENTICATED USER 
